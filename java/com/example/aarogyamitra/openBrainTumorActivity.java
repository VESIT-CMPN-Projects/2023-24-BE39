...
public class openBrainTumorActivity extends AppCompatActivity {
    ...
    private static final int TARGET_WIDTH = 150; // Adjust as needed
    private static final int TARGET_HEIGHT = 150; // Adjust as needed
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_open_brain_tumor);
            ...
            public void onClick(View v) {
                if (img != null) {
                    try {
                        ...
                        BrainTumor model = BrainTumor.newInstance(openBrainTumorActivity.this);
    ...
    private String getPredictionString(int predictedClass) {
        switch (predictedClass) {
            case 0:
                return "Glioma Tumor";
            case 1:
                return "The model predicts that there is no tumor";
            case 2:
